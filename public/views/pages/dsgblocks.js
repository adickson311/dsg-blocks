/*   DSG Blocks Page V3.5
	 Requires: jQuery 1.2.3 (up to 1.9.x), purl.js, blocks array file
*/
...
var BlocksPage = {
	...
	sortData: function(){
		...
		this.categoryData.sort(function(a,b){
			if (a[this.category] > b[this.category]) return 1;
			if (a[this.category] < b[this.category]) return -1;
			return 0;
		});
	...
	buildBlocks: function(){
		...
		for(var blockItem in this.categoryData){
			var blockObj = this.categoryData[blockItem],
